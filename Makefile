...
help:
	...
	@echo "  register-app-cluster - One-time: spoke SA token -> LocalStack for Argo CD cluster registration"
...
# Register dev-applications spoke with Argo CD on the hub (LocalStack + ExternalSecret).
